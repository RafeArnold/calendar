...
buildscript {
    dependencies {
        classpath("org.xerial:sqlite-jdbc:3.53.0.0")
    }
}
...
dependencies {
    ...
    testImplementation("org.wiremock:wiremock:4.0.0-beta.32")
    testRuntimeOnly("org.eclipse.jetty.ee10:jetty-ee10-servlet:12.1.8")
